...
4. After the previous step, in the command line window it will ask for a host, simply enter the IP/URL of the server you want to connect to and then press the `ENTER` key to proceed.
